...
if (!$page) {redirect_to(url_for('/staff/subjects/index.php'));}
...
if(is_post_request()) {
  ...
  // post request sonrası redirekt yapmak için gerekli olan subject id alternatif olarak aşağıdaki invisible fieldden veya form actiondaki url'ye eklenecek query string ile yollanabilirdi 
}
...
<div id="content">
  ...
  <div class="page delete">
    ...
    <form action="<?php echo url_for('/staff/pages/delete.php?id=' . h(u($page['id']))); ?>" method="post">
      ...
      <input type="hidden" name="invisible" value= "<?php echo h($page['subject_id']); ?>" />  
    </form>
  </div>
